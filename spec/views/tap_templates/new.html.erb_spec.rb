...
RSpec.describe "tap_templates/new", type: :view do
  before(:each) do
    assign(:tap_template, TapTemplate.new(
      :name => "MyString",
  ...
  it "renders new tap_template form" do
    render

    assert_select "form[action=?][method=?]", tap_templates_path, "post" do
      ...
      assert_select "input[name=?]", "tap_template[risk_category_according_to_DESP_2014_68]"
