...
RSpec.describe "taps/new", type: :view do
  before(:each) do
    assign(:tap, Tap.new(
      :name => "MyString",
  ...
  it "renders new tap form" do
    render

    assert_select "form[action=?][method=?]", taps_path, "post" do
      ...
      assert_select "input[name=?]", "tap[risk_category_according_to_DESP_2014_68]"
