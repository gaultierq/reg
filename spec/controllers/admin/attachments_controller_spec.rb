  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Attachment" do
        expect {
          post :create, params: {admin_attachment: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_attachment: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_attachment" do
        attachment = Admin::Attachment.create! valid_attributes
        put :update, params: {id: attachment.to_param, admin_attachment: new_attributes}, session: valid_session
        attachment.reload
      ...
      it "redirects to the admin_attachment" do
        attachment = Admin::Attachment.create! valid_attributes
        put :update, params: {id: attachment.to_param, admin_attachment: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        attachment = Admin::Attachment.create! valid_attributes
        put :update, params: {id: attachment.to_param, admin_attachment: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
