...
RSpec.describe TapsController, type: :controller do
  ...
  # TapsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "returns a success response" do
      tap = Tap.create! valid_attributes
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created tap" do
        post :create, params: {tap: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Tap.last)
      end
    end
